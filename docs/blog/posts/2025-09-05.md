...
<div id="symbol-carousel" class="hidden md:block flex overflow-x-auto gap-2 py-2 px-1 whitespace-nowrap text-sm font-mono border-b border-gray-300"></div>
<div class="hidden md:block border-2 border-solid border-red rounded-lg shadow-lg ml-0 w-full">
  <div id="stock-data-chart" class="w-full  h-[180px] overflow-hidden rounded-lg shadow-md border border-gray-300 bg-transparent"></div>
</div>

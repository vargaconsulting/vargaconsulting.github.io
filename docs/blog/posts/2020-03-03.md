---
title: "CSV to HDF5 with H5CPP and Fast C++ CSV Parser"
date: 2020-03-03
slug: csv-to-hdf5
tags:
  - h5cpp
  ...
  - data-ingestion
summary: |
  Convert CSV to compressed HDF5 with just a few lines of modern C++.
  Use a POD struct, a fast CSV parser, and let H5CPP handle the rest.
---
# CSV to HDF5 

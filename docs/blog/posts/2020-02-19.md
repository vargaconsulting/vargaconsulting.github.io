---
title: "H5Pset_shared_mesg_nindexes() Fails for N > 8 in HDF5 1.10.6"
date: 2020-02-19
slug: hdf5-shared-mesg-nindexes-limit
tags:
  - hdf5
  - api-bug
  ...
  - documentation
summary: |
  The HDF5 API allows setting the number of shared message indexes with `H5Pset_shared_mesg_nindexes()`,  
  but fails silently for `N > 8` despite documentation omitting the constraint.  
  The hardcoded maximum (`H5O_SHMESG_MAX_NINDEXES`) should be documented to avoid runtime surprises.
---

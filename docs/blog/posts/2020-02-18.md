---
title: "H5Pset_istore_k() Fails for Values Above 16384 in HDF5 1.10.6"
date: 2020-02-18
slug: hdf5-set-istore-k-bug
tags:
  - hdf5
  - api-bug
  - btree
  ...
  - documentation
summary: |
  Although the HDF5 documentation suggests `ik=65536` as a valid maximum for `H5Pset_istore_k()`,  
  HDF5 1.10.6 (and possibly others) rejects values greater than 16384.  
  A minimal C repro shows the call fails with "Bad value" above that threshold.
---

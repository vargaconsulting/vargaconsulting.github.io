...
<div id="asciicast-iex2h5-issue-93-problem" class="hidden md:block asciicast-player border border-solid border-gray-3
...
<div id="asciicast-iex-termshark" class="hidden md:block asciicast-player border border-solid border-gray-3 rounded-lg shadow-lg w-1/2 overflow-hidden mb-2 mr-4 float-left text-[9px]"></div>            

---
title: "Cross-Compiling HDF5 with Platform-Aware Feature Detection"
date: 2020-03-25
slug: hdf5-cross-compile-features
tags:
  - hdf5
  - cross-compilation
  - cmake
  ...
  - h5cpp
summary: |
  Cross-compiling HDF5? Don't rely on `try_run()`.  
  Generate the feature macros with confidence—on target or ahead of time.
---

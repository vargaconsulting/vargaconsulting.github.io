---
title: "Rewriting Attributes in HDF5 with H5CPP"
date: 2022-03-15
slug: hdf5-rewrite-attributes
tags:
  - h5cpp
  - hdf5
  - attributes
  ...
  - data-modeling
summary: |
  While HDF5 doesn’t support extending attributes directly, you can emulate it by reading, rewriting, and replacing.  
  This post shows how to do it cleanly with H5CPP, and fall back on HDF5 C API when needed.
---

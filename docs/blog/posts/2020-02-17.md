---
title: "H5Pset_sizes() Crashes for 16-byte Offsets in HDF5 1.10.6"
date: 2020-02-17
slug: hdf5-set-sizes-crash
tags:
  - hdf5
  - crash
  - H5Pset_sizes
...
categories:
  ...
  - c++  
summary: |
  The HDF5 API allows configuring user-defined offset and length sizes using `H5Pset_sizes()`,  
  but using `16` bytes for either crashes the library in version 1.10.6.  
  This violates the documentation, which claims 16-byte values are valid.
---

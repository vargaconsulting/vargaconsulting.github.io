...
## Where it fits :material-bitcoin:{.icon} :material-ethereum:{.icon}
...
Perfect addition :material-check-all: Let’s extend the list and flag **StarkNet**, which is a special case.
